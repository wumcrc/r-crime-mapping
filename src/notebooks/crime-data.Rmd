...
fpsebound <- filter(nhoods_sf, NHD_NUM == 38 )
cwebound <- filter(nhoods_sf, NHD_NUM == 39 )
botbound <- filter(nhoods_sf, NHD_NUM == 28 )
dbpbound <- filter(nhoods_sf, NHD_NUM == 47 )
sdbbound <- filter(nhoods_sf, NHD_NUM == 46 )
webound <- filter(nhoods_sf, NHD_NUM == 48 )
vpbound <- filter(nhoods_sf, NHD_NUM == 49 )
acbound <- filter(nhoods_sf, NHD_NUM == 51 )
fpbound <- filter(nhoods_sf, NHD_NUM == 53 )
lpbound <- filter(nhoods_sf, NHD_NUM == 54 )
vdbound <- filter(nhoods_sf,NHD_NUM == 58 )
```
