...
totalCrimes18 %>%
  ...
  adorn_totals(., "row", name = "Total") -> ac_2018
...
ytdCrimes19 %>%
  ...
  rename(., "Part 1 Crimes" = crimeCatName) %>%
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") -> ac_2019
```
...
monthCrimes19 %>%
  ...
  count() %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Number of Crimes" = n, "Day of the Week" = weekday) -> ac_weekDay
...
totalCrimes18 %>%
  ...
  rename(., "Part 1 Crimes" = crimeCatName) %>%
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") -> fp_2018
...
ytdCrimes19 %>%
  ...
  rename(., "Part 1 Crimes" = crimeCatName) %>%
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") -> fp_2019
```
...
monthCrimes19 %>%
  ...
  count() %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Number of Crimes" = n, "Day of the Week" = weekday) -> fp_weekDay
...
totalCrimes18 %>%
  ...
  rename(., "Part 1 Crimes" = crimeCatName) %>%
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") -> lp_2018
...
ytdCrimes19 %>%
  ...
  rename(., "Part 1 Crimes" = crimeCatName) %>%
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") -> lp_2019
```
...
monthCrimes19 %>%
  ...
  count() %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Number of Crimes" = n, "Day of the Week" = weekday) -> lp_weekDay
...
totalCrimes18 %>%
  ...
  rename(., "Part 1 Crimes" = crimeCatName) %>%
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") -> vd_2018
...
ytdCrimes19 %>%
  ...
  rename(., "Part 1 Crimes" = crimeCatName) %>%
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") -> vd_2019
```
...
monthCrimes19 %>%
  ...
  count() %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Number of Crimes" = n, "Day of the Week" = weekday) -> vd_weekDay
...
ggsave(here("results", params$year, params$month, "ac", "ac_crime_timeDay_graph.jpeg"), dpi = 300)
```
...
ggsave(here("results", params$year, params$month, "ac", "ac_crimeCat_weekday_graph.jpeg"), dpi = 300)
```
...
ggsave(here("results", params$year, params$month, "fp", "fp_crime_timeDay_graph.jpeg"), dpi = 300)
```
...
ggsave(here("results", params$year, params$month, "fp", "fp_crimeCat_weekday_graph.jpeg"), dpi = 300)
```
...
ggsave(here("results", params$year, params$month, "lp", "lp_crime_timeDay_graph.jpeg"), dpi = 300)
```
...
ggsave(here("results", params$year, params$month, "lp", "lp_crimeCat_weekday_graph.jpeg"), dpi = 300)
```
...
ggsave(here("results", params$year, params$month, "vd", "vd_crime_timeDay_graph.jpeg"), dpi = 300)
```
...
ggsave(here("results", params$year, params$month, "vd", "vd_crimeCat_weekday_graph.jpeg"), dpi = 300)
```
