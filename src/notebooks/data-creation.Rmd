...
params:
  ...
  pastyear: 2018
  year: 2019 
  ytd: "2019-01-01"                   # Compiles Year to Date Dataset for this year | Leave at January 1st 2019
  date: "2019-12-01"                  # Pulls in the data for the most recent month | Change this each month
  pastdate: "2018-01-01"              # Compiles Year to Date Dataset for previous year | Leave at January 1st 2018 
  pstdtmonth: "2018-12-01"            # Compiles Data for the most recent month of the previous year | This is the first day of the month
  pstdtmonth2: "2018-12-31"           # Compiles Data for the most recent month of the previous year | This is the last day of month | Must be the 30th or 31st
---
...
cs_validate(yearlist18, year = 2018)                            # Identifies problems with SLMPD Data
...
ytdCrimes19$monthVar <- month(as.Date(ytdCrimes19$monthVar, 
                                      format="%d/%m/%Y"), label = TRUE)                   # Pulls out the Month based on the Date | i.e 10/01/2018 = "October" 

ytdCrimes19$neighborhood <- as.numeric(ytdCrimes19$neighborhood)                          # Formats the neighborhood variable as numeric
ytdCrimes19$tod <- strptime(ytdCrimes19$tod, tz = "America/Chicago", "%H:%M")             # Strips & Reformats the structure of the time variable
