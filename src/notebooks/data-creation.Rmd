...
save(fpse_tiles, cwe_tiles, bot_tiles, dbp_tiles, sdb_tiles, we_tiles, vp_tiles, ac_tiles, fp_tiles, lp_tiles, vd_tiles, mc_tiles, ctx_tiles, grv_tiles, dst2_tiles, file = here("data", "basemap-files", "mapbox-tiles.rda"))
```
...
mc_crimes_ytd19_sf <- st_intersection(monthCrimes19_sf, med_campus)
...
# Save
save(totalCrimes18_sf, ytdCrimes18_sf, ytdCrimes19_sf, monthCrimes18_sf, monthCrimes19_sf, mc_crimes_month18_sf, mc_crimes_month19_sf, mc_crimes_ytd18_sf, mc_crimes_ytd19_sf, mc_larcenies_sf, dst_2_pop_sf, dst_5_pop_sf, file = here("data", "spatial-crime-data.rda"))

save(ytdCrimes18, ytdCrimes19, monthCrimes18, monthCrimes19, totalCrimes18, larceny, mc_crimes_month18, mc_crimes_month19, mc_crimes19, mc_crimes_ytd18, mc_crimes_ytd19, mc_larcenies, dst_2, dst_5, file = here("data", "crime-data.rda"))
