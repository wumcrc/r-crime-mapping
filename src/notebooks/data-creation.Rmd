...
mc_crimes19_sf <- st_intersection(monthCrimes19_sf, med_campus)
mc_crimes19 <- mc_crimes19_sf %>% 
   as.data.frame()

mc_crimes18_sf <- st_intersection(totalCrimes18_sf, med_campus) 

mc_crimes18 <- mc_crimes18_sf %>% 
   as.data.frame() 
...
save(totalCrimes18_sf, monthCrimes19_sf, mc_crimes19_sf, dst_2_pop, dst_5_pop, file = here("data", "spatial-crime-data.rda"))

save(ytdCrimes19, monthCrimes18, monthCrimes19, ytdCrimes18, totalCrimes18, larceny, mc_crimes18, mc_crimes19, dst_2, dst_5, file = here("data", "crime-data.rda"))
