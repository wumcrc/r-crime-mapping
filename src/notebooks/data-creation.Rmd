...
c_yearCrimes <- cs_collapse(yearlist19) 
```
...
c_yearCrimes$neighborhood <- as.numeric(c_yearCrimes$neighborhood)
c_yearCrimes$tod <- strptime(c_yearCrimes$tod, tz = "America/Chicago", "%H:%M")
c_yearCrimes$tod <- format(c_yearCrimes$tod, format = "%H%M%S")
...
```{r}
save(c_yearCrimes, monthCrimes18, monthCrimes19, ytdCrimes18, totalCrimes18, larceny, file = here("data", "crime-data.rda"))
```
