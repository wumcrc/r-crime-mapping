---
title: "Skinker DeBaliviere, DeBaliviere Place, West End, and Visitation Park"
...
```{r SDB Summary Notes, echo = FALSE}
...
```{r District 2 Density Map Explanation Knit, echo = FALSE}
...
```{r CWE Summary Notes Knit, echo = FALSE}
sprintf("%s total crimes in August 2019", tc19)
sprintf("%s change compared to August 2018 (%s total crimes)", pct_chg_mth, tc18)
sprintf("%s crime(s) against persons in August 2019", cap19)
sprintf("%s change compared to August 2018 (%s crimes against persons)", pct_chg_cap, cap18)
...
```{r WUMC Summary Knit, echo = FALSE}
sprintf("%s total crimes in August 2019", tc19)
sprintf("%s change compared to August 2018 (%s total crimes)", pct_chg_mth, tc18)
sprintf("%s crime(s) against persons in August 2019", cap19)
sprintf("%s change compared to August 2018 (%s crimes against persons)", pct_chg_cap, cap18)
...
```{r District 5 Density Map Explanation Knit, echo = FALSE}
