...
part1crimes[!(part1crimes %in% sdb_2018$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(sdb_2018, crimeCatName = missing_category) -> sdb_2018
}
...
sdb_2018 %>% 
  ...
  rename(., "Part 1 Crimes" = crimeCatName) -> sdb_2018
...
part1crimes[!(part1crimes %in% dbp_2018$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(dbp_2018, crimeCatName = missing_category) -> dbp_2018
}
...
dbp_2018 %>% 
  ...
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Part 1 Crimes" = crimeCatName) -> dbp_2018
...
part1crimes[!(part1crimes %in% we_2018$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(we_2018, crimeCatName = missing_category) -> we_2018
}
...
we_2018 %>% 
  ...
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Part 1 Crimes" = crimeCatName) -> we_2018
...
part1crimes[!(part1crimes %in% vp_2018$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(vp_2018, crimeCatName = missing_category) -> vp_2018
}
...
vp_2018 %>% 
  ...
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Part 1 Crimes" = crimeCatName) -> vp_2018
