...
```
```{r}
part1crimes <- c("Aggravated Assault", "Arson", "Burgalry", "Homicide", "Larceny", "Motor Vehicle Theft", "Rape", "Robbery")
```

```{r}
for (chr in part1crimes) { 
  if(fpse_2019$`Part 1 Crimes` != chr)  
    add_row(fpse_2019, `Part 1 Crimes` == chr) 
  } -> fortest
