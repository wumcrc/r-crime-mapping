...
wkdys <- c("Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday")
# tmap_options()
```
...
if(test == FALSE) {
   add_row(bot_2018, crimeCatName = missing_category) -> bot_2019
}
...
if(test == FALSE) {
   add_row(fpse_2019, crimeCatName = missing_category) -> cwe_2019
}
