...
```{r}
fpse_crimes <- rasterize(filter(crimes19_sf, neighborhood == 39))
  
fpseden <- smooth_map(fpse_crimes, bandwidth = 0.5, style = "pretty", cover = fpse)
```

```{r}
tm_shape(fpsedens$polygons) +
